...
-- ============================================================
-- MIGRACIÓN — TABLAS ROL Y PERMISO SEPARADAS (antes DAL/nuevoScript.sql, consolidado aquí)
-- ============================================================
...
AS
    SELECT ID, USUARIO_ID, USUARIO_LOGIN, ROL, ROL_ID, BLOQUEADO, INTENTOS_FALLIDOS,
           PERFILES, FECHA_CAMBIO, REALIZADO_POR, TIPO_CAMBIO, VERSION_ORIGEN, NOMBRE, APELLIDO, TELEFONO, EMAIL
    FROM USUARIO_HISTORIAL
    WHERE USUARIO_ID = @usuario_id
    ORDER BY ID DESC
GO
...
-- ============================================================
-- PAGINACIÓN — BITACORA, USUARIO_HISTORIAL, USUARIO (antes DAL/paginado.sql, consolidado aquí)
-- ============================================================
